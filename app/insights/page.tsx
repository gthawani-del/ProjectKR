...
export default function InsightsPage(){
  return <InternalShell><main>
    <section className="internal-hero"><div><div className="internal-kicker">Regulatory Radar</div><h1>Signals, analysis and perspective.</h1><p>A structured view of legal and regulatory developments connected to Krida Legal’s core sectors. Published updates should be lawyer-reviewed and linked to primary sources.</p></div><aside className="internal-side"><small>Filter concepts</small><div className="tag-list"><span className="tag">Sport</span><span className="tag">Gaming</span><span className="tag">IP</span><span className="tag">India</span><span className="tag">Global</span></div></aside></section>
