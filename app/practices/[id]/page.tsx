...
export default async function PracticePage({params}:{params:Promise<{id:string}>}){
 ...
 return <InternalShell><main>
  <section className="internal-hero"><div><div className="internal-kicker">Practice</div><h1>{practice.name}</h1><p>{practice.summary}</p></div><aside className="internal-side"><small>Krida Legal capability</small><p>Structured from the firm’s established practice content and presented as an informational overview.</p></aside></section>
